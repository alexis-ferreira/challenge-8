...
let sourceImgSlider = ["./images/mobile-image-hero-1.jpg","./images/mobile-image-hero-2.jpg","./images/mobile-image-hero-3.jpg"];
// console.log(sourceImgSlider);

let sourceTitleSlider = ["We are available all across the globe","Manufactured with the best materials","Discover innovative ways to decorate"];
// console.log(sourceTitleSlider);

let sourceTextSlider = ["With stores all over the world, it's easy for you to find furniture for your home or place of business. Locally, we’re in most major cities throughout the country. Find the branch nearest you using our store locator. Any questions? Don't hesitate to contact us today.",
